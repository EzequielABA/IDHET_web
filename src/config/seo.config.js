...
export const seoConfig = {
    ...
    pages: {
        home: {
            title: 'IDHET - Innovación Digital en República Dominicana',
            description: 'Desarrollamos soluciones digitales que simplifican la vida cotidiana. MetroCard, pagos electrónicos y más.',
        },
        about: {
            title: 'Sobre IDHET - Nuestra Historia y Valores',
            description: 'Conoce más sobre IDHET, empresa tecnológica dominicana comprometida con la innovación y el desarrollo digital.',
        },
        solutions: {
        ...
        contact: {
            title: 'Contacto - IDHET',
            description: 'Ponte en contacto con nosotros. Estamos aquí para ayudarte con tus consultas y proyectos.',
        },
    },
};
