...
export const CONTACT_PHONE = '+1 (809) 555-0100';
export const COMPANY_ADDRESS = 'Santo Domingo, República Dominicana';

export const SOCIAL_MEDIA = {
    FACEBOOK: 'https://facebook.com/idhet',
    TWITTER: 'https://twitter.com/idhet_rd',
    INSTAGRAM: 'https://instagram.com/idhet_rd',
    LINKEDIN: 'https://linkedin.com/company/idhet',
};
